...
class Utilisateurs extends BaseUser
{
     ...
     * Add adress
     *
     * @param \Utilisateurs\UtilisateursBundle\Entity\UtilisateursAdresses $adress
     *
     * @return Utilisateurs
     */
    public function addAdress(\Utilisateurs\UtilisateursBundle\Entity\UtilisateursAdresses $adress)
    {
     ...
     * @param \Utilisateurs\UtilisateursBundle\Entity\UtilisateursAdresses $adress
     */
    public function removeAdress(\Utilisateurs\UtilisateursBundle\Entity\UtilisateursAdresses $adress)
    {
